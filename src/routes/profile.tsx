...
export function Profile() {
  ...
  return (
    <AppShell title="Home" fullBleed>
      <div className="profile-dark min-h-[calc(100vh-3.5rem)] bg-[#121212] px-4 pt-6 text-zinc-100 sm:px-6 sm:pt-8 md:min-h-[calc(100vh-4rem)]">
        <div className="mx-auto max-w-4xl space-y-7">
          <section className="flex flex-col items-center gap-5 sm:flex-row sm:items-center sm:text-left">
            <div className="relative shrink-0">
              {avatar ? (
                <button
                  type="button"
                  onClick={() => setPreviewingAvatar(true)}
                  className="group relative h-24 w-24 overflow-hidden rounded-full ring-2 ring-white/10 transition-transform hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 sm:h-28 sm:w-28"
              ...
              <Button
                ...
                size="icon"
                variant="ghost"
                className="absolute -right-1 -bottom-1 h-8 w-8 rounded-full bg-[#1b1b1b] text-zinc-300 ring-1 ring-white/10 hover:bg-white/10 hover:text-zinc-100"
            ...
            <div className="min-w-0 flex-1 text-center sm:text-left">
              <p className="text-[11px] font-semibold tracking-[0.16em] text-zinc-500 uppercase">
                {tracker?.meta.examName || "Your exam"}
              </p>
              <h2 className="mt-1 truncate text-2xl font-semibold text-zinc-50">{displayName}</h2>
              <p className="mt-1 text-sm text-zinc-400">
                Keep the streak going. Track syllabus, sit a mock, or review recent scores.
              </p>
              <div className="mt-4 flex flex-wrap items-center justify-center gap-2 sm:justify-start">
                <Button className="h-9 bg-emerald-600 hover:bg-emerald-500" asChild>
                  <Link to="/test" search={{}}>
                    Start a test
                  </Link>
                </Button>
                <Button
                  ...
                  size="sm"
                  variant="ghost"
                  className="h-9 gap-1.5 text-zinc-300 hover:bg-white/10 hover:text-white"
                ...
                <Button
                  ...
                  size="sm"
                  variant="ghost"
                  className="h-9 gap-1.5 text-zinc-400 hover:bg-white/10 hover:text-zinc-100"
          ...
          <section className="border-t border-white/10 pt-5 sm:pt-6">
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-base font-semibold">Recent practice</h2>
              <Link
                to="/history"
